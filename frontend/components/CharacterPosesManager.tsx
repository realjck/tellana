...
function SpritePicker({
  ...
  return (
    <>
      ...
      <div className="absolute left-0 top-full mt-1 bg-slate-800 border border-slate-600 rounded-xl p-3 z-[70] shadow-2xl w-64">
          ...
          {DEFAULT_SPRITES.map((s) => (
            <button
              ...
              className={`p-0.5 rounded border-2 transition-colors ${
                current?.url === s.url ? "border-blue-500" : "border-transparent hover:border-slate-500"
              }`}
              title={s.label}
            >
            ...
            <div className="grid grid-cols-3 gap-1.5 mb-2">
              {customUploads.map((ref) => (
                <button
                  ...
                  className={`p-0.5 rounded border-2 transition-colors ${
                    current?.url === ref.url ? "border-blue-500" : "border-transparent hover:border-slate-500"
                  }`}
        ...
        <button
          ...
          disabled={uploading}
          className="w-full py-1.5 rounded-lg border border-dashed border-slate-600 hover:border-slate-400 text-slate-400 hover:text-white text-xs transition-colors"
        >
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide">
        ...
        {poseCount > 0 && (
          <span className="ml-1 text-slate-500">({poseCount} pose{poseCount > 1 ? "s" : ""})</span>
        )}
      </div>
              ...
              <div className="relative flex-shrink-0">
                ...
                >
                  <img
                    ...
                    alt={row.key}
                    className="h-12 w-8 object-contain rounded-lg bg-slate-700"
                  />
                ...
                {isDefault ? (
                  ...
                  <div className="flex flex-col gap-1">
                    <input
                      ...
                      className="w-full bg-slate-700 border border-slate-600 rounded-lg px-2 py-1 text-xs text-white focus:outline-none focus:border-blue-500"
              ...
              <div className="flex-shrink-0">
                {isBeingSaved ? (
                  ...
                  <button
                    ...
                    className="p-1 rounded-lg text-slate-500 hover:text-red-400 hover:bg-red-900/20 transition-colors"
